...
const campsData: Record<string, CampDetails> = {
  "ljetni-kamp-zagreb-2024": {
    ...
    included: [
      ...
      { item: "Ručak i/ili užine svaki dan", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Ovisno o trajanju kampa, ako je kamp duži od poludnevnog onda su svi obroci i užine uključeni. Molimo vas da nas obavijestite o eventualnim alergijama ili posebnim prehrambenim potrebama.",
      },
      {
        question: "Što ako pada kiša?",
        answer:
          "U slučaju većih elementarnih nepogoda ćemo naći alternativu, u slučaju manjih elementarnih nepogoda treninzi se održavaju",
      },
      {
        question: "Mogu li roditelji pratiti treninge?",
        answer:
          "Naravno! Roditelji su dobrodošli pogledati treninge. Roditelji mogu pratiti treninge s tribina, odnosno izvan terena.",
      },
      {
