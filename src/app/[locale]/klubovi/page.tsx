...
const currentPartners = [
  { name: "GNK Dinamo Zagreb", image: "/images/clubs/Dinamov-grb.webp" },
  { name: "NK Olimpija Ljubljana", image: "/images/clubs/NK_Olimpija_Ljubljana.webp" },
  { name: "FC Lugano", image: "/images/clubs/FC-Lugano-new-1.webp" },
  { name: "NK Rudeš", image: "/images/clubs/NK-RUDES.webp" },
  { name: "NK Triglav Kranj", image: "/images/clubs/NK-Triglav-Kranj.webp" },
  { name: "NK Zelina", image: "/images/clubs/NK-Zelina.webp" },
  { name: "NK Novi Marof", image: "/images/clubs/Novi-Marof-png.webp" },
  { name: "ŠN Maksimir", image: "/images/clubs/SN-Maksimir.webp" },
  { name: "Alfa Academy", image: "/images/clubs/alfa academy.webp" },
  { name: "Deportivo Alavés", image: "/images/clubs/Deportivo Alaves.webp" },
  { name: "Hornets Warriors", image: "/images/clubs/Hornets Warriors.jpeg" },
  { name: "Lumen", image: "/images/clubs/Lumen.webp" },
  { name: "NK Graničar Đurđevac", image: "/images/clubs/NK Graničar Đurđevac.webp" },
  { name: "NK Hvar", image: "/images/clubs/NK Hvar 1.webp" },
  { name: "NK Kralj Tomislav", image: "/images/clubs/NK Kralj Tomislav.webp" },
  { name: "NK Kustošija", image: "/images/clubs/NK Kustošija.webp" },
  { name: "NK Lio Osijek", image: "/images/clubs/NK Lio Osijek.webp" },
  { name: "NK Ljubuški", image: "/images/clubs/NK Ljubuški.webp" },
  { name: "NK Lokomotiva Rijeka", image: "/images/clubs/NK Lokomotiva Rijeka.webp" },
  { name: "NK Sesvete", image: "/images/clubs/NK Sesvete.webp" },
  { name: "NK Špansko", image: "/images/clubs/NK Špansko.webp" },
  { name: "NK Studentski Grad", image: "/images/clubs/NK Studentski grad.webp" },
  { name: "NK Vis", image: "/images/clubs/NK Vis.webp" },
  { name: "NK Šmartno", image: "/images/clubs/NK_Smartno.webp" },
  { name: "RNK Split", image: "/images/clubs/RNK Split.jpeg" },
  { name: "ŠF Šampion", image: "/images/clubs/ŠF Šampion.webp" },
];
        ...
        <div className="container mx-auto px-6 lg:px-8 relative py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[0.95] mb-6">
              {t("hero.titleLine1")}
              <br />
              <span className="text-coerver-green">{t("hero.titleLine2")}</span>
            </h1>
          ...
          <div className="hidden lg:flex absolute bottom-12 right-8 gap-8">
            {[0, 1, 2].map((index) => (
              <div key={index} className="text-right">
                <div className="text-3xl font-black text-white">{t(`stats.${index}.value`)}</div>
                <div className="text-white/50 text-sm">{t(`stats.${index}.label`)}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("benefits.badge")}</span>
            </div>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {benefitIcons.map((icon, index) => (
              ...
              >
                ...
                <p className="text-gray-600">{t(`benefits.items.${index}.description`)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      */}
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("partners.badge")}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-coerver-dark mb-4">
              {t("partners.title")}
            </h2>
      ...
      <section className="py-24 lg:py-32 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("process.badge")}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-coerver-dark mb-4">
              {t("process.title")}
            </h2>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {processIcons.map((icon, index) => (
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">{t(`process.steps.${index}.description`)}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-24 lg:py-32 bg-coerver-dark relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonialPeople.map((testimonial, index) => (
              <div
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-white/50 text-sm">{t(`testimonials.items.${index}.role`)}</div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start max-w-6xl mx-auto">
            <div className="animate-on-scroll text-white">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-2xl p-4">
                  ...
                  <div>
                    <div className="text-white/60 text-sm">{t("contact.emailLabel")}</div>
                ...
                <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-2xl p-4">
                  ...
                  <div>
                    <div className="text-white/60 text-sm">{t("contact.phoneLabel")}</div>
              ...
              <div className="mt-10 pt-10 border-t border-white/20">
                <div className="text-white/60 text-sm mb-4">{t("contact.badgesTitle")}</div>
                <div className="flex flex-wrap gap-4">
                  {[0, 1, 2].map((index) => (
                    <div key={index} className="flex items-center gap-2 bg-white/10 rounded-full px-4 py-2">
                      ...
                      <span className="text-white text-sm font-medium">{t(`contact.badges.${index}`)}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="animate-on-scroll">
              <InquiryForm type="club" title={t("contact.formTitle")} />
            </div>
          </div>
        </div>
      </section>
