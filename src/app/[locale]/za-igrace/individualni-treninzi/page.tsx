...
const coachNames = ["Ante Bašić", "Toni Volarević", "Tomislav Jelenski"];
...
export default function IndividualniTreninziPage() {
  const t = useTranslations("players.individual");
  ...
  const coaches = coachNames.map((name, index) => ({
    name,
    title: t(`coaches.${index}.title`),
    licence: t(`coaches.${index}.licence`),
    experience: t(`coaches.${index}.experience`),
  }));

  const steps = ["1", "2", "3", "4"].map((step, index) => ({
    step,
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-24 lg:py-32 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("coaches.badge")}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-coerver-dark mb-4">
              {t("coaches.title")}
            </h2>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start max-w-6xl mx-auto">
            <div className="animate-on-scroll">
              <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
                <span className="text-coerver-green text-sm font-semibold">{t("booking.badge")}</span>
              </div>
              ...
              <div className="bg-gray-50 rounded-3xl p-8">
                <h4 className="font-bold text-coerver-dark mb-6">{t("booking.needToKnow")}</h4>
            ...
            <div className="animate-on-scroll">
              <InquiryForm type="individual" title={t("booking.formTitle")} />
            </div>
          </div>
        </div>
      </section>
