...
export default function CoerverIntroClient({ courses }: { courses: Course[] }) {
  const t = useTranslations("coaches.intro");

  const curriculum = [
    {
      time: "09:00 - 10:30",
      topic: t("curriculum.0.topic"),
      description: t("curriculum.0.desc"),
      icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253",
    },
    {
      time: "10:30 - 10:45",
      topic: t("curriculum.1.topic"),
      description: "",
      icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
    },
    {
      time: "10:45 - 12:30",
      topic: t("curriculum.2.topic"),
      description: t("curriculum.2.desc"),
      icon: "M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z",
    },
    {
      time: "12:30 - 13:30",
      topic: t("curriculum.3.topic"),
      description: "",
      icon: "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z",
    },
    {
      time: "13:30 - 15:00",
      topic: t("curriculum.4.topic"),
      description: t("curriculum.4.desc"),
      icon: "M13 10V3L4 14h7v7l9-11h-7z",
    },
    {
      time: "15:00 - 15:15",
      topic: t("curriculum.5.topic"),
      description: "",
      icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",
    },
    {
      time: "15:15 - 17:00",
      topic: t("curriculum.6.topic"),
      description: t("curriculum.6.desc"),
      icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
    },
  ];

  const whatYouGet = [
    { item: t("included.0"), icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" },
    { item: t("included.1"), icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" },
    { item: t("included.2"), icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
    { item: t("included.3"), icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
  ];

  const whatYoullLearn = [
    {
      title: t("learn.0.title"),
      description: t("learn.0.desc"),
      icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
    },
    {
      title: "Ball Mastery",
      description: t("learn.1.desc"),
      icon: "M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z",
    },
    {
      title: "1v1",
      description: t("learn.2.desc"),
      icon: "M13 10V3L4 14h7v7l9-11h-7z",
    },
  ];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative py-32">
          <div className="max-w-3xl">
            ...
            <nav className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-white/20">
              <Link href="/za-trenere" className="text-white/60 hover:text-white text-sm transition-colors">{t("breadcrumb")}</Link>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("learnBadge")}</span>
            </div>
        ...
        <div className="container mx-auto px-6 lg:px-8 relative">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/20 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("scheduleBadge")}</span>
            </div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <div className="animate-on-scroll">
              ...
              <div className="mb-8">
                <Image
                  src="/images/logo-variations/coerver-intro-white.jpg"
                  alt="Coerver Intro"
                  width={220}
                  height={90}
              ...
              <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
                <span className="text-coerver-green text-sm font-semibold">{t("includedBadge")}</span>
              </div>
      ...
      <section className="py-24 lg:py-32 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("datesBadge")}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-coerver-dark mb-4">
              {t("datesTitle")}
            </h2>
          ...
          {courses.length === 0 ? (
            <div className="text-center py-12 max-w-xl mx-auto">
              ...
              <h3 className="text-lg font-bold text-coerver-dark mb-2">{t("noDates")}</h3>
              ...
              {courses.map((course, index) => (
                ...
                >
                  <div className="text-3xl font-black text-coerver-dark mb-2">
                    {course.start_date && formatDateForDisplay(course.start_date)}
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    {course.capacity && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-500">{t("spots", { count: course.capacity })}</span>
                      </div>
                    )}
                    <a
                      href="#prijava"
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          <div className="animate-on-scroll max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("nextBadge")}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-coerver-dark mb-6">
              {t("nextTitle")}
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start max-w-6xl mx-auto">
            <div className="animate-on-scroll text-white">
              <div className="inline-flex items-center gap-2 bg-coerver-green/20 rounded-full px-4 py-2 mb-6 border border-coerver-green/30">
                ...
                <span className="text-coerver-green text-sm font-semibold">{t("regBadge")}</span>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
                <h4 className="font-bold text-lg mb-6">{t("courseInfo")}</h4>
                <div className="space-y-4">
                  {[
                    { label: t("info.0.label"), sublabel: t("info.0.sublabel") },
                    { label: t("info.1.label"), sublabel: t("info.1.sublabel") },
                  ].map((item) => (
            ...
            <div className="animate-on-scroll">
              <InquiryForm type="course" programId="coerver-intro" programName="Coerver Intro" title={t("formTitle")} />
            </div>
          </div>
        </div>
      </section>
