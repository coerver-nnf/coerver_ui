...
export default function ZaTrenerePage() {
  const t = useTranslations("coaches.index");
  ...
  const courses = [
    {
      ...
      duration: t("courses.0.duration"),
      price: null,
      href: "/za-trenere/coerver-intro",
      level: t("courses.0.level"),
      levelNum: 1,
    ...
    },
    {
      ...
      duration: t("courses.1.duration"),
      price: null,
      href: "/za-trenere/youth-diploma-1",
      level: t("courses.1.level"),
      levelNum: 2,
  ...
  const stats = [
    { value: "1000+", label: t("stats.0") },
    { value: "3", label: t("stats.1") },
    { value: "40+", label: t("stats.2") },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[90vh] flex items-center bg-coerver-dark overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative py-32">
          <div className="max-w-3xl">
            ...
            {t("heroTitleTop")}
              <br />
              <span className="text-coerver-green">Coerver®</span> {t("heroTitleBottom")}
            </h1>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("pathBadge")}</span>
            </div>
        ...
        <div className="container mx-auto px-6 lg:px-8 relative">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/20 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("benefitsBadge")}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-white mb-4">
              {t("benefitsTitlePre")} <span className="text-coerver-green">Coerver®</span> {t("benefitsTitlePost")}
            </h2>
          </div>
      ...
      <section className="py-24 lg:py-32 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("coursesBadge")}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-coerver-dark mb-4">
              {t("coursesTitle")}
            </h2>
                ...
                <div className={cn(index % 2 === 1 && "lg:col-start-2")}>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="bg-white rounded-2xl p-4">
                      <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">{t("duration")}</div>
                      <div className="font-bold text-coerver-dark">{course.duration}</div>
                    </div>
                    <div className="bg-white rounded-2xl p-4">
                      <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">{t("price")}</div>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("testimonialsBadge")}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-coerver-dark mb-4">
              {t("testimonialsTitle")}
            </h2>
