...
export default function YouthDiploma2Client({ courses }: { courses: Course[] }) {
  const t = useTranslations("coaches.yd2");
  ...
  const pathway = [
    { name: "Coerver Intro", level: t("levels.0"), levelNum: 1, completed: true },
    { name: "Youth Diploma 1", level: t("levels.1"), levelNum: 2, completed: true },
    { name: "Youth Diploma 2", level: t("levels.2"), levelNum: 3, current: true },
  ];
        ...
        <div className="container mx-auto px-6 lg:px-8 relative">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/20 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("pathwayBadge")}</span>
            </div>
      ...
      <section id="prijava" className="py-24 lg:py-32 bg-coerver-dark relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start max-w-6xl mx-auto">
            <div className="animate-on-scroll text-white">
              ...
              <div className="bg-coerver-green/20 rounded-2xl p-6 border border-coerver-green/30">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-coerver-green font-bold">{t("groupDiscount")}</span>
                </div>
            ...
            <div className="animate-on-scroll">
              <InquiryForm type="course" programId="youth-diploma-2" programName="Youth Diploma 2" title={t("formTitle")} />
            </div>
          </div>
        </div>
      </section>
