...
export default function YouthDiploma1Client({ courses }: { courses: Course[] }) {
  const t = useTranslations("coaches.yd1");

  const modules = [
    {
      title: t("modules.0.title"),
      description: t("modules.0.desc"),
      topics: [],
  ...
  const daySchedule = {
    day1: {
      title: t("day1Title"),
      items: [
        { time: "18:00 – 18:10", activity: t("day1.0") },
        { time: "18:10 – 18:40", activity: t("day1.1") },
        { time: "18:40 – 18:50", activity: t("day1.2"), isPause: true },
        { time: "18:50 – 19:20", activity: t("day1.3") },
        { time: "19:20 – 19:30", activity: t("day1.4"), isPause: true },
        { time: "19:30 – 20:00", activity: t("day1.5") },
        { time: "20:00 – 20:10", activity: t("day1.6"), isPause: true },
        { time: "20:10 – 20:40", activity: t("day1.7") },
        { time: "20:40 – 20:55", activity: t("day1.8") },
      ],
    },
    day2: {
      title: t("day2Title"),
      items: [
        { time: "12:00 – 13:15", activity: t("day2.0") },
        { time: "13:15 – 13:30", activity: t("day2.1"), isPause: true },
        { time: "13:30 – 14:45", activity: t("day2.2") },
        { time: "14:45 – 15:45", activity: t("day2.3"), isPause: true },
        { time: "15:45 – 17:00", activity: t("day2.4") },
        { time: "17:15 – 17:30", activity: t("day2.5"), isPause: true },
        { time: "17:30 – 18:45", activity: t("day2.6") },
        { time: "18:45 – 19:15", activity: t("day2.7") },
      ],
    },
  };
        ...
        <div className="container mx-auto px-6 lg:px-8 relative py-32">
          <div className="max-w-3xl">
            ...
            <div className="inline-flex items-center gap-2 bg-coerver-green/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-coerver-green/30">
              <span className="text-coerver-green text-sm font-semibold">{t("levelBadge")}</span>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              {[
                ...
                { label: t("format"), value: t("formatValue") },
              ].map((item) => (
                <div
                  key={item.label}
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-coerver-green/10 rounded-full px-4 py-2 mb-6">
              <span className="text-coerver-green text-sm font-semibold">{t("modulesBadge")}</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="animate-on-scroll bg-white/5 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/10">
              <div className="bg-coerver-green p-6">
                <span className="text-white font-bold text-xl">{t("dayLabel", { num: 1 })}</span>
            ...
            <div className="animate-on-scroll bg-white/5 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/10" style={{ transitionDelay: "100ms" }}>
              <div className="bg-coerver-green p-6">
                <span className="text-white font-bold text-xl">{t("dayLabel", { num: 2 })}</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start max-w-6xl mx-auto">
            <div className="animate-on-scroll text-white">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                <h4 className="font-bold text-lg mb-6">{t("prereqTitle")}</h4>
                <div className="space-y-4">
                  {[
                    t("prereq.0"),
                  ].map((item) => (
            ...
            <div className="animate-on-scroll">
              <InquiryForm type="course" programId="youth-diploma-1" programName="Youth Diploma 1" title={t("formTitle")} />
            </div>
          </div>
        </div>
      </section>
