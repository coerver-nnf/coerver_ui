        ...
        <div className="container mx-auto px-6 lg:px-8 relative">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight mb-6">
              {t("hero.title")} <span className="text-coerver-green">{t("hero.titleHighlight")}</span>
            </h1>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          {posts.length === 0 ? (
            <div className="text-center py-16 max-w-xl mx-auto">
              ...
              <h3 className="text-xl font-bold text-coerver-dark mb-2">{t("empty.title")}</h3>
            ...
            <>
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-coerver-dark">{t("featured")}</h2>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-coerver-dark font-medium text-sm">
                              {featuredPost.author.full_name || t("team")}
                            </p>
                            <p className="text-gray-500 text-sm">
                              {formatDate(featuredPost.created_at, locale)}
                            </p>
                          </div>
                        </div>
                      )}
      ...
      {posts.length > 0 && (
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-2xl font-bold text-coerver-dark">{t("allArticles")}</h2>
            <p className="text-gray-500">
          ...
          {filteredPosts.length > 0 ? (
                  ...
                  <article className="h-full flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col">
                      <div className="flex items-center gap-3 text-sm text-gray-500 mb-3">
                        <span>{formatDateShort(post.created_at, locale)}</span>
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-bold text-coerver-dark mb-2">{t("noResults.title")}</h3>
              <p className="text-gray-500">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-coerver-green/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-coerver-green text-sm font-semibold">{t("newsletter.badge")}</span>
            </div>
