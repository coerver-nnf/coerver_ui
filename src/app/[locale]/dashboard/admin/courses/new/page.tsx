...
import { createCourse, CourseType, COURSE_TYPE_LABELS } from "@/lib/api/courses";
...
const courseSchema = z.object({
  ...
  type: z.enum(["coerver-intro", "youth-diploma-1", "youth-diploma-2"]).optional(),
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-coerver-gray-900">Novi tečaj</h1>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-coerver-gray-200 p-6 space-y-4">
          ...
          <Input
            ...
            placeholder="Npr. Youth Diploma 1 - Zagreb"
          />
