...
export function AdminSidebar({ counts }: AdminSidebarProps) {
  ...
  return (
    <aside className="w-64 bg-white border-r border-coerver-gray-200 min-h-screen">
      {/* Logo */}
      ...
      {/* Bottom section */}
      <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-coerver-gray-200 space-y-1">
        <Link
          href="/dashboard"
