...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://instagram.com/coervercoachingcroatia",
    icon: (
  ...
  {
    name: "TikTok",
    href: "https://tiktok.com/@coervercoachingcroatia",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Facebook",
    href: "https://facebook.com/coervercoachingcroatia",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "YouTube",
    href: "https://youtube.com/@coervercoachingcroatia",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
function FullscreenNav({ isOpen, onClose }: FullscreenNavProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-hidden">
      ...
      <div className="absolute inset-0 flex">
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className={cn(
              "flex-1 bg-coerver-dark transition-transform duration-700 ease-[cubic-bezier(0.76,0,0.24,1)]",
      ...
      <div
        className={cn(
          "relative h-full transition-opacity duration-500 delay-300",
      ...
      >
        ...
        <div className="relative h-full grid lg:grid-cols-12">
          ...
          <div className="lg:col-span-7 h-full flex flex-col">
            ...
            {/* Navigation */}
            <nav className="flex-1 flex items-center px-6 lg:px-10 xl:px-16">
                ...
                {navigationItems.map((item, index) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        transitionDelay: isAnimating ? `${400 + index * 80}ms` : '0ms'
                      }}
                    >
                      {item.children ? (
                        <div
                        ...
                        >
                          ...
                          >
                            <span className={cn(
                              "text-4xl lg:text-6xl xl:text-7xl font-black uppercase tracking-tighter transition-all duration-300",
                              isActive || isExpanded
                                ? "text-white"
                            ...
                            <div className="flex flex-wrap gap-3">
                              {item.children.map((child, childIdx) => (
                                <Link
                                  ...
                                  onClick={onClose}
                                  className={cn(
                                    "px-5 py-2.5 rounded-full border border-white/20 text-white/70 hover:bg-coerver-green hover:border-coerver-green hover:text-white transition-all duration-300",
                        ...
                        <Link
                          href={item.href}
                          onClick={onClose}
                          className="flex items-center justify-between py-5 lg:py-6 group"
                        >
                          <span className={cn(
                            "text-4xl lg:text-6xl xl:text-7xl font-black uppercase tracking-tighter transition-all duration-300",
                            isActive
                          ...
                          <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-0 translate-x-4">
                            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div
              className={cn(
                "p-6 lg:p-10 flex items-center justify-between transition-all duration-500",
            ...
            >
              <div className="flex items-center gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-11 h-11 rounded-full bg-white/10 hover:bg-coerver-green flex items-center justify-center text-white/60 hover:text-white transition-all duration-300"
              ...
              <Link
                href="/kontakt"
                onClick={onClose}
                className="group inline-flex items-center gap-3 bg-white text-coerver-dark hover:bg-coerver-green hover:text-white font-bold px-6 py-3 rounded-full transition-all duration-300"
              >
          ...
          {/* Right - Visual */}
          <div className="hidden lg:flex lg:col-span-5 flex-col p-6 lg:p-10">
            {/* Close button */}
